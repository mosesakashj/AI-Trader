...
object FirestoreMapper {
    ...
    fun botConfigToMap(config: BotConfigEntity): Map<String, Any> = mapOf(
        ...
        "adaptiveTpEnabled" to config.adaptiveTpEnabled,
        "adaptiveSlEnabled" to config.adaptiveSlEnabled,
        "adaptiveBeEnabled" to config.adaptiveBeEnabled,
        "xauusdTimeframe" to config.xauusdTimeframe,
        "btcusdTimeframe" to config.btcusdTimeframe,
        "ethusdTimeframe" to config.ethusdTimeframe,
        "solusdTimeframe" to config.solusdTimeframe,
        "usoilTimeframe" to config.usoilTimeframe,
        "eurusdTimeframe" to config.eurusdTimeframe,
        "gbpusdTimeframe" to config.gbpusdTimeframe,
        "usdjpyTimeframe" to config.usdjpyTimeframe,
        "audusdTimeframe" to config.audusdTimeframe,
        "usdcadTimeframe" to config.usdcadTimeframe,
        "usdchfTimeframe" to config.usdchfTimeframe,
        "nzdusdTimeframe" to config.nzdusdTimeframe,
        "eurgbpTimeframe" to config.eurgbpTimeframe,
        "eurjpyTimeframe" to config.eurjpyTimeframe,
        "gbpjpyTimeframe" to config.gbpjpyTimeframe,
    ...
    fun mapToBotConfig(map: Map<String, Any>): BotConfigEntity = BotConfigEntity(
        ...
        tradeMode = map["tradeMode"] as? String ?: "BALANCED",
        ...
        adaptiveTpEnabled = map["adaptiveTpEnabled"] as? Boolean ?: true,
        adaptiveSlEnabled = map["adaptiveSlEnabled"] as? Boolean ?: true,
        adaptiveBeEnabled = map["adaptiveBeEnabled"] as? Boolean ?: true,
        xauusdTimeframe = map["xauusdTimeframe"] as? String ?: "",
        btcusdTimeframe = map["btcusdTimeframe"] as? String ?: "",
        ethusdTimeframe = map["ethusdTimeframe"] as? String ?: "",
        solusdTimeframe = map["solusdTimeframe"] as? String ?: "",
        usoilTimeframe = map["usoilTimeframe"] as? String ?: "",
        eurusdTimeframe = map["eurusdTimeframe"] as? String ?: "",
        gbpusdTimeframe = map["gbpusdTimeframe"] as? String ?: "",
        usdjpyTimeframe = map["usdjpyTimeframe"] as? String ?: "",
        audusdTimeframe = map["audusdTimeframe"] as? String ?: "",
        usdcadTimeframe = map["usdcadTimeframe"] as? String ?: "",
        usdchfTimeframe = map["usdchfTimeframe"] as? String ?: "",
        nzdusdTimeframe = map["nzdusdTimeframe"] as? String ?: "",
        eurgbpTimeframe = map["eurgbpTimeframe"] as? String ?: "",
        eurjpyTimeframe = map["eurjpyTimeframe"] as? String ?: "",
        gbpjpyTimeframe = map["gbpjpyTimeframe"] as? String ?: "",
